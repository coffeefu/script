...
def parse_json(user_uid,dbname):
	page=1
	while 1:
		url='https://m.weibo.cn/api/container/getIndex?uid={uid}&luicode=10000011&type=uid&value={uid}&containerid=107603{uid}&page={page}'
		r=requests.get(url.format(uid=user_uid,page=page))
